      ...
      <div className="flex flex-col md:min-w-40 border">
        {categories?.map((category) => (
          <Button
            ...
            key={category?._id}
            className={`bg-transparent border-0 p-0  rounded-none text-darkColor shadow-none hover:bg-shop_orange/20 hover:text-white font-semibold hoverEffect border-b last:border-b-0 transition-colors capitalize ${category?.slug?.current === currentSlug && "bg-shop_orange text-white border-shop_orange"}`}
          >
